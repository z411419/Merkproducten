...
public class GUI_DAO extends JFrame {
    ...
    private void initComponents() {
        ...
        lblList.setBackground(Color.LIGHT_GRAY);
        lblList.setText("Productenlijst");
        lblTotaal = new JLabel("Totale prijs: " + order.totalePrijs());
        ...
        //Merkveld
        txtMerk = new JTextField("Georgio Armani", 15);
